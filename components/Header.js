				...
				<main className={styles.mainContainer}>
					<div className={styles.centerContainer}>
						...
						<div className={styles.logo}>
							<svg className={styles.blob} viewBox="0 0 800 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" width="100%" id="blobSvg">
								<g transform="translate(167.27891540527344, -9.636116027832031)">
									<defs>
										<linearGradient id="paint0_linear_2_124" x1="299.149" y1="0.0905151" x2="299.149" y2="605.401" gradientUnits="userSpaceOnUse">
											<stop stopColor="#0099FF" />
											<stop offset="1" stopColor="#08D9D6" />
										</linearGradient>

									</defs>
									<path className="blob" d="M394.5,349Q364,448,268.5,416Q173,384,92.5,317Q12,250,73.5,150.5Q135,51,237.5,73Q340,95,382.5,172.5Q425,250,394.5,349Z" fill="url(#paint0_linear_2_124)">
										{/* <animate
										attributeName="d"
										dur="5000ms"
